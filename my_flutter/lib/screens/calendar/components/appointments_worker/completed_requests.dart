...
class CompletedRequestsWorker extends StatefulWidget {
  ...
  const CompletedRequestsWorker({Key? key, this.userID}) : super(key: key);
  @override
  _AppointmentsState createState() => _AppointmentsState();
}

class _AppointmentsState extends State<CompletedRequestsWorker> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Container(height: double.infinity, child: Icon(Icons.star)),
